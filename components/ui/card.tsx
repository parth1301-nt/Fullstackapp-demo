  ...
  return (
    <div
      ...
      className={cn(
        ...
        "data-[interactive]:cursor-default data-[interactive]:hover:shadow-md",
...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-2 px-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:border-border [.border-b]:pb-6",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-4 px-6 [.border-t]:border-border [.border-t]:pt-6",
        className
      )}
      {...props}
    />
