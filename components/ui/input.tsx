...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex h-11 w-full min-w-0 min-h-11 rounded-md border border-input bg-transparent px-4 py-2 text-base leading-normal shadow-sm md:text-sm",
        ...
        "motion-safe:transition-[color,box-shadow,border-color] motion-safe:duration-200 motion-reduce:transition-none",
